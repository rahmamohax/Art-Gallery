...
<div id="wrapper">
        ...
        <div id="banner-content" class="row clearfix">
            ...
            <div class="col-38">
                ...
                <div class="section-heading">
                    ...
                    <h2>Art has never been easier to access and admire! Want to decor your house? Want to admire others work?
                        Want to display your own artwork? We got you, and much more to be explored here!.
                    </h2>
                </div>

                <!--Call to Action-->
                <a href="browse.php" class="button">START CREATING TODAY</a>
                <!--End Call to Action-->
        ...
        <div id="services" class="scrollto clearfix">
            ...
            <div class="row no-padding-bottom clearfix">
                ...
                <div class="col-3">
                    ...
                    <a href="egift.php" class="button "><i class="fa-solid fa-gift"></i> Make E-Gift</a>
                </div>
    ...
    <footer id="landing-footer" class="clearfix">
        <div class="row clearfix">
            ...
            <p id="copyright" class="col-2">Made with love by <a href="contact.php">ShapingRain</a></p>
